-- Vendored verbatim from /usr/share/omarchy-nvim/config/lua/plugins/omarchy-theme-hotreload.lua.
-- Requires plugins.theme, so it only works alongside the theme.lua symlink.
return {
	{
