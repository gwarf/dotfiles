-- Vendored verbatim from /usr/share/omarchy-nvim/config/lua/config/remote_clipboard.lua.
-- Module name kept so Omarchy migrations that grep config.remote_clipboard stay idempotent.
